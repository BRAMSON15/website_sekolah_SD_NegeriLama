  ...
  <div class="card-box">
    ...
    <div style="margin-bottom: 24px;">
      ...
      <p style="color: var(--muted); font-size: 1rem; padding-left: 16px; border-left: 4px solid var(--primary);">
        "Terwujudnya Peserta Didik yang Bertaqwa, Berprestasi Tinggi, Berkarakter Pancasila, dan Berwawasan Lingkungan Global."
      </p>
    </div>
    <div>
      ...
      <ul style="color: var(--muted); padding-left: 20px; font-size: 0.95rem; line-height: 1.8;">
        <li>Menanamkan nilai-nilai keimanan dan ketaqwaan kepada Tuhan Yang Maha Esa melalui kegiatan keagamaan rutin.</li>
        <li>Menyelenggarakan proses pembelajaran yang aktif, kreatif, inovatif, dan menyenangkan berbasis teknologi informasi.</li>
        <li>Mendorong dan memfasilitasi siswa untuk menguasai ilmu pengetahuan dan teknologi serta meraih prestasi dalam lomba akademik maupun non-akademik.</li>
        <li>Membentuk karakter siswa yang sopan, santun, jujur, serta memiliki kepedulian sosial dan lingkungan.</li>
      </ul>
    </div>
  </div>
